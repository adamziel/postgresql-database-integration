...
class WP_PostgreSQL_Connection_Tests extends TestCase {
	 ...
	 * @return array
	 */
	public static function data_missing_dbname_options(): array {
		return array(
			'not set' => array( array() ),
	 ...
	 * @return array
	 */
	public static function data_nul_byte_dsn_options(): array {
		return array(
			'host'   => array(
				array(
					'host'   => "local\0host",
	 ...
	 */
	public static function data_locking_select_statements(): array {
		return array(
