...
require_once getcwd() . '/../wp-includes/postgresql/class-wp-postgresql-db.php';
...
PHP
	...
	public function test_real_wpdb_prepare_identifier_placeholders_use_postgresql_quotes(): void {
		$wpdb_file = __DIR__ . '/wordpress-stubs/class-wpdb.php';
		if ( ! is_readable( $wpdb_file ) ) {
			$this->markTestSkipped( 'Real WordPress wpdb class is not included in the standalone repository.' );
		}
	...
	require_once getcwd() . '/wordpress-stubs/class-wpdb.php';
	require_once getcwd() . '/../wp-includes/postgresql/class-wp-postgresql-db.php';
