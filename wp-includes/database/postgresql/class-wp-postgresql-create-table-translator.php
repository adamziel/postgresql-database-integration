...
$wp_mysql_set_domain$',
	 ...
	 *
	 * MySQL accepts these as MEDIUMTEXT-like aliases, same as LONG VARCHAR.
	 * Rewrite only the tokenized type alias so parsing remains bounded while
	 * downstream metadata normalization still sees a LONG-prefixed text alias.
	 *
	 * @param string $sql MySQL SQL.
	 ...
	 *
	 * PostgreSQL has JSON casts but no MySQL JSON_VALID() function. Casting
